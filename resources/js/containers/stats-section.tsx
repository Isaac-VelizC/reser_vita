...
export default function StatsSection() {
  ...
  return (
    ...
    >
      {/* Decorativo */}
      <div className="absolute inset-0 bg-gradient-to-br from-blue-100 dark:from-gray-900 via-transparent to-green-100 dark:to-gray-950 pointer-events-none"></div>
