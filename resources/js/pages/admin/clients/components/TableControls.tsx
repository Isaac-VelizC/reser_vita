            ...
            <CardContent>
                <div className="flex flex-col gap-4">
                    <div className="flex flex-col items-center justify-center gap-4 lg:flex-row lg:justify-between">
                        ...
                        <div className="flex flex-col items-center gap-4 lg:flex-row lg:min-w-sm">
                            <Select
                                value={statusFilter}
                                onValueChange={(value) =>
                            ...
                            <Button startIcon={<Plus />} className="whitespace-nowrap" onClick={() => setModalOpen(true) }>Nuevo Cliente</Button>
                        </div>
                    </div>
                        ...
                        >
                            <div className="flex items-center justify-between">
                                <span className="text-sm text-muted-foreground">
                                    {bulkSelected.length}{' '}
                                    {pluralize('cliente', bulkSelected.length)}{' '}
                                    seleccionado
